...
import { depositHelpers, exchangeHelpers, bankHelpers, clientHelpers, userHelpers } from '../lib/database'
import './DepositForm.css'

export default function DepositForm({ selectedChat }) {
  const [formData, setFormData] = useState({
    ...
    bonusAmount: '',
    referenceNo: '',
    staffUserId: '' // Staff user handling the deposit
  })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.bonusAmount && parseFloat(formData.bonusAmount) < 0) {
      ...
      // Create deposit using the database helper
      const depositData = {
        date: formData.date,
        bank: formData.bank,
