...
DepositSchema.index({ companyId: 1, date: -1 })
DepositSchema.index({ clientId: 1, date: -1 })
DepositSchema.index({ bankId: 1, date: -1 })
DepositSchema.index({ exchangeId: 1, date: -1 })
DepositSchema.index({ createdBy: 1, date: -1 })
DepositSchema.index({ isVerified: 1, isRejected: 1 })
